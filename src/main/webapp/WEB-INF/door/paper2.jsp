		...
		<div class="sc-list-content">
			...
			<ul class="sc-list clearfix">
				<li <c:if test="${year==0 }">class="selected"</c:if>>
					<a href="<%=path %>/door/tozt/${subid }-${type }-0-${pagenum }.action">全部</a>
				</li>
				<li <c:if test="${year==2018 }">class="selected"</c:if>>
					<a href="<%=path %>/door/tozt/${subid }-${type }-2018-${pagenum }.action">2018</a>
				</li>
				<li <c:if test="${year==2017 }">class="selected"</c:if>>
					<a href="<%=path %>/door/tozt/${subid }-${type }-2017-${pagenum }.action">2017</a>
				</li>
				<li <c:if test="${year==2016 }">class="selected"</c:if>>
					<a href="<%=path %>/door/tozt/${subid }-${type }-2016-${pagenum }.action">2016</a>
				</li>
				<li <c:if test="${year==2015 }">class="selected"</c:if>>
					<a href="<%=path %>/door/tozt/${subid }-${type }-2015-${pagenum }.action">2015</a>
				</li>
				<li <c:if test="${year==2014 }">class="selected"</c:if>>
					<a href="<%=path %>/door/tozt/${subid }-${type }-2014-${pagenum }.action">2014</a>
				</li>
			</ul>
		</div>
		...
		<div class="mainlist">
			...
			<div class="paperlist-content">
				<div class="paperlist">
					...
					<a class="paper-link" href="<%=path%>/upload/${item.point}" download="${item.point}">下载真题</a>
				</div>
			</div>
			</c:forEach>
