...
<body class="childrenBody">
	...
	<form action="<%=path %>/chapter/data.action" >
		<input type="hidden" name="pageNumber" id="pageNumber">
		<input type="hidden" name="pageSize" id="pageSize">
	
		<div class="layui-inline">
		    <div class="layui-input-inline">
		    	<input type="text" value="${checkname }" name="checkname" placeholder="请输入章节名称" class="layui-input search_input">
		    </div>
		    <input type="submit" class="layui-btn search_btn" value="查询">
		</div>
		<div class="layui-inline">
			<a class="layui-btn layui-btn-normal newsAdd_btn">添加章节</a>
		</div>
		<div class="layui-inline">
	...
	<script type="text/javascript" src="<%=path %>/js/chapter/list.js"></script>
