...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main">
				<a href="#" class="logo" id="fontzm">成人自考题库后台管理</a>
				<!-- 显示/隐藏菜单 -->
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="<%=path %>/layui/images/face.jpg" class="layui-circle" width="35" height="35">
							<cite>${uname }</cite>
						</a>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="<%=path %>/layui/images/face.jpg"></a>
				<p>你好！<span class="userName">${uname}</span>, 欢迎登录</p>
			</div>
			...
			<div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="<%=path %>/layui/page/main.html"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="<%=path %>/layui/js/leftNav.js"></script>
