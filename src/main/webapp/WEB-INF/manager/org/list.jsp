...
<body class="childrenBody">
	...
	<form action="<%=path%>/org/data.action" >
		...
		<div class="layui-inline">
		    <div class="layui-input-inline">
		    	<input type="text" value="${orgname }" name="orgname" placeholder="请输入组织架构名称" class="layui-input search_input">
		    </div>
	...
	<script type="text/javascript" src="<%=path %>/js/org/list.js"></script>
</body>
</html>