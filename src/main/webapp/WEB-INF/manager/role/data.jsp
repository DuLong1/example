...
<body class="childrenBody">
	...
	<form action="<%=path %>/role/data.action" >
		...
		<div class="layui-inline">
		    <div class="layui-input-inline">
		    	<input type="text" value="${role.rolename }" name="rolename" placeholder="请输入角色名称" class="layui-input search_input">
		    </div>
		    ...
		    <c:choose>
		    	...
		    	<c:otherwise>
		    		<c:forEach items="${page.page.list }" var="item">
		    			...
		    			<a class="layui-btn layui-btn-danger layui-btn-mini news_qx" data-id="${item.id }"><i class="layui-icon">&#xe630;</i> 权限</a>
	...
	<script type="text/javascript" src="<%=path %>/js/role/list.js"></script>
	<%--<script type="text/javascript" src="<%=path %>/js/layui/page/news/newsList.js"></script>
--%></body>
</html>