...
<body class="childrenBody">
	...
	<form action="<%=path %>/user/data.action" >
		...
		<div class="layui-inline">
		    <div class="layui-input-inline">
		    	<input type="text" value="${user.realname }" name="realname" placeholder="请输入用户名称" class="layui-input search_input">
		    </div>
	...
	<script type="text/javascript" src="<%=path %>/js/user/list.js"></script>
